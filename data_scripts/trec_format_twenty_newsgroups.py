...
def make_doc_ids(target_location, doc_ids):
    ...
    with open(os.path.join(docids_path, "20newsgroups.docids.txt"), "w") as docids_file:
...
def make_doctext(target_location, docs):
    ...
    with open(os.path.join(doctext_path, "20newsgroups.collection.json"), "w") as doctext_file:
        for doc in docs:
...
if __name__ == "__main__":
    ...
    target_location = "./data/20newsgroups"
